...
from agents.checa.cooling_device_controller.cooling_device_controller import CoolingDeviceController
from agents.checa.forecast_agent.forecasting_agent import ForecastAgent
...
class Checa(Agent):
    ...
    def get_future_cooling_demands(self, obs, action_proposals):
        ...
        for b in range(self.n_buildings):
            ...
            setpoint = obs[self.observation_names_b.index(f'indoor_dry_bulb_temperature_cooling_set_point_{b}')]
